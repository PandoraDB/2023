...
#
# from .dcnv3_simam import DCNv3_pytorch
#
#
# @MODELS.register_module()
# class PPYOLOEHeadModuleFinal(BaseModule):
...
#             conv.weight.data.fill_(0.)
#
#     def upsample_layer(self, in_channels: int) -> nn.Module:
...
#
#
#     def down_sample_layer(self, in_channels: int) -> nn.Module:
#         """build upsample layer."""
#         # fpn_route
#         return nn.Sequential(
#             ConvModule(
...
#
#         self.dcn_se_down = nn.ModuleList()
#         self.dcn_se = nn.ModuleList()
#         self.dcn_se_up = nn.ModuleList()
#         # total_block = [self.block_down, self.block, self.block_up]
#
#         for i, in_channel in enumerate(self.in_channels):
#             self.dcn_se_down.append(DCNv3_pytorch(in_channel // 2))
#             self.dcn_se.append(DCNv3_pytorch(in_channel))
#             self.block_down.append(self.down_sample_layer(in_channel // 2))
#             if i != 2:
#                 self.block_up.append(self.upsample_layer(in_channel*2))
#                 self.dcn_se_up.append(DCNv3_pytorch(in_channel * 2))
#             else:
#                 self.block_up.append(nn.ReLU())
#                 self.dcn_se_up.append(nn.ReLU())
#
#
...
#                            self.block_down, self.block_up,
#                            self.dcn_se_down, self.dcn_se, self.dcn_se_up)
#
...
#                        block_down: nn.ModuleList, block_up: nn.ModuleList,
#                        dcn_se_down: nn.ModuleList, dcn_se: nn.ModuleList, dcn_se_up: nn.ModuleList) -> Tensor:
...
#
# @MODELS.register_module()
# class PPYOLOEHeadFinal(YOLOv6Head):
