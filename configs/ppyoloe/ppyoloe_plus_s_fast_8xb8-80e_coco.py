...
# dataset settings
data_root = '/home/datasets/VisDrone2019-DET-test-dev/'
dataset_type = 'YOLOv5CocoDataset'


class_name = ('car', 'van', 'truck', 'bus', 'motor')
num_classes = len(class_name)
metainfo = dict(classes=class_name, palette=[(20, 220, 60), (220, 20, 60), (20, 60, 220), (220, 220, 60), (60, 220, 220)])
...
model = dict(
    ...
    bbox_head=dict(
        type='PPYOLOEHead',
        # type='PPYOLOEHeadFinal',
        head_module=dict(
            # type='PPYOLOEHeadModule',
            type='PPYOLOEHeadModuleFinal',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
       ann_file='VisDrone2019-DET_train_coco_change.json',
       data_prefix=dict(img='VisDrone2019-DET-train/images'),
        # ann_file='connected_0.05/VisDrone2019-DET_train_coco.json',
        # data_prefix=dict(img='connected_0.05/merge_images'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        filter_cfg=dict(filter_empty_gt=True, min_size=0),
        ann_file='VisDrone2019-DET_test_coco_change.json',
...
val_evaluator = dict(
    ...
    ann_file=data_root + 'VisDrone2019-DET_test_coco_change.json',
    metric='bbox')
